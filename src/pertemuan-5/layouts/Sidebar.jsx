    ...
    return (
        <div id="sidebar" className="flex min-h-screen w-90 flex-col bg-white p-10 shadow-lg">
                ...
                <ul id="menu-list" className="space-y-3">
                    ...
                    <li>
                        <div id="menu-2" className="hover:text-hijau flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:bg-green-200 hover:font-extrabold transition-all">
                            <FiShoppingCart className="mr-4 text-xl" />
                            Orders
                        </div>
                    </li>
                    <li>
            ...
            <div id="sidebar-footer" className="mt-auto">
                <div id="footer-card" className="bg-hijau px-4 py-4 rounded-md shadow-lg mb-10 flex items-center justify-between">
                    <div id="footer-text" className="text-white text-sm">
                        <span className="block pr-2">Please organize your menus through button below!</span>
